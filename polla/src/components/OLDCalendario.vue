...
<v-app id="inspire">
    ...
    <span v-else>Ver hora en Colombiax</span>
    </button>
{{ grupoActivo }} --- {{ horamostrable }} <v-btn color="primary" dark @click.stop="dialog = true">Open Dialog 1</v-btn> {{datosUsuarioWordpress.id}} -- {{ datosUsuarioWordpress.data.nickname}}
...
<v-data-table
    ...
    <template slot="footer">
      <td colspan="100%">
        <strong>This is an extra pata de tabla</strong>
      </td>
    </template>
  </v-data-table>
        ...
        <div class="a"><grupo_rusia :partidosgrupo="partidos_grupo('A')"></grupo_rusia></div> 
        <div class="b"><grupo_rusia :partidosgrupo="partidos_grupo('B')"></grupo_rusia></div>
        <div class="c">
            <grupo_rusia :partidosgrupo="partidos_grupo('B')"></grupo_rusia>
        </div>
        <div class="d"><grupo_rusia :partidosgrupo="partidos_grupo('C')"></grupo_rusia></div>
        <div class="e"><grupo_rusia :partidosgrupo="partidos_grupo('D')"></grupo_rusia></div>
        <div class="f"><grupo_rusia :partidosgrupo="partidos_grupo('E')"></grupo_rusia></div>
        <div class="g"><grupo_rusia :partidosgrupo="partidos_grupo('F')"></grupo_rusia></div>
        <div class="h"><grupo_rusia :partidosgrupo="partidos_grupo('G')"></grupo_rusia></div>
...
<!--
        <ul>
        <li v-for="partido in calendario">
            {{ partido.ciudad}}
...
<!--
    { "local": "1", "visitante": "2", "grupo": "A", 
    "fecha": "2018-06-14 18:00:00", 
    "ciudad": "Moscú", "estadio": "Estadio Olímpico Luzhnikí", "hora": "3" }, 
 -->
